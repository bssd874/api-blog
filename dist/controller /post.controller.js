...
var PostController = /** @class */ (function () {
    function PostController(postService) {
        ...
        this.createPost = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, title, content, thumbnail, post, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, title = _a.title, content = _a.content;
                        thumbnail = req.file ? "/uploads/".concat(req.file.filename) : undefined;
        ...
        this.getAllPosts = function (_req, res) { return __awaiter(_this, void 0, void 0, function () {
            var posts, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        posts = _a.sent();
                        res.json(posts.map(function (post) { return post.toDTO(); }));
                        return [3 /*break*/, 3];
                    case 2:
                        error_2 = _a.sent();
                        res.status(500).json({ message: "Something went wrong" });
        ...
        this.getPostById = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var id, post, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
